...
if ($mode == 'save') {
  ...
  $block_new_mac_address = $form['block_new_mac_address'];

  $qry = "UPDATE settings SET svalue='$block_new_mac_address' WHERE skey='block_new_mac_address'";
  $ret = db_query($qry);
...
<tr>
 <th>신규 발견 맥주소 차단</th>
 <td>
<input type='radio' name='block_new_mac_address' value='1' id='bnma1'$chk1><label for='bnma1'>차단</label>
<input type='radio' name='block_new_mac_address' value='0' id='bnma0'$chk0><label for='bnma0'>허용</label>
</td>
</tr>
